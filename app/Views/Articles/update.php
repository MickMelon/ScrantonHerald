<div class="container">
    <form name="createArticleForm" action="index.php?controller=article&action=submit_update" method="post" enctype="multipart/form-data">
        <input type="hidden" id="articleId" name="articleId" value="<?= $article['ID'] ?>" />
        <div class="form-group">
            <label for="headline">Headline*</label>
            <input type="text" class="form-control" id="headline" name="headline" value="<?= $article['Headline'] ?>" maxlength="80" minlength="3" required />
        ...
        <div class="form-group">
            ...
            <textarea rows="10" class="form-control" id="content" name="content" minlength="3" maxlength="63206" required>
                <?= $article['Content'] ?>
            </textarea>
